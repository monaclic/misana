        ...
        <div>
          ...
          <ul class="grid grid-cols-2 sm:grid-cols-3 gap-3">
            ...
            <li v-if="['nice', 'monaco', 'cannes', 'saint-tropez'].includes(ct.slug)">
              <NuxtLink :to="localePath('/services/helicopter')" class="block border border-misana-line hover:border-misana-ink transition px-4 py-3 text-center">
                <span class="text-sm">{{ t('nav.helicopter') }}</span>
              </NuxtLink>
            </li>
            <li>
              <NuxtLink :to="localePath('/services/cars')" class="block border border-misana-line hover:border-misana-ink transition px-4 py-3 text-center">
            ...
            <li>
              <NuxtLink :to="localePath('/services/access')" class="block border border-misana-line hover:border-misana-ink transition px-4 py-3 text-center">
