...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    public: {
      ...
      misanaPhone: process.env.NUXT_PUBLIC_MISANA_PHONE || '33749185548',
      misanaWhatsapp: process.env.NUXT_PUBLIC_MISANA_WHATSAPP || process.env.NUXT_PUBLIC_MISANA_PHONE || '33749185548',
    },
  },
