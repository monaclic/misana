...
const DETAILS: Record<string, EventDetail> = {
  ...
  'mipim': {
    ...
    aboutText: {
      fr: 'Le MIPIM est le rendez-vous mondial des décideurs de l\'immobilier depuis 1990. Pendant quatre jours en mars, le Palais des Festivals de Cannes accueille promoteurs, investisseurs institutionnels, architectes, fonds souverains, municipalités. Quatre-vingts pays exposent, cent mille mètres carrés de stands, deux mille sociétés présentes. Les hôtels de la Croisette servent de salles de réunion privées, les yachts ancrés en rade hébergent les déjeuners business, le Carlton concentre les networking privé. Notre service couvre les transferts business (chauffeur dédié 4 jours, hélicoptère depuis Nice), la location de SUV pour délégations, le yacht-bureau pour meetings privés, et l\'accès aux soirées promoteurs sur invitation.',
      en: 'MIPIM is the global rendezvous of property decision-makers since 1990. During four days in March, the Palais des Festivals in Cannes gathers developers, institutional investors, architects, sovereign funds, municipalities. Eighty countries exhibit, one hundred thousand square metres of stands, two thousand companies present. Croisette hotels serve as private meeting rooms, anchored yachts host business lunches, the Carlton concentrates private networking. Our service covers business transfers (4-day dedicated chauffeur, helicopter from Nice), SUV rental for delegations, yacht-office for private meetings, and access to developer parties on invitation.',
    },
