// Header nav V1 simplifie : pas de mega menu, liens directs uniquement.
// Les pages destinations et events restent accessibles via le footer et
// les CTA in-page. Mega menu reviendra quand toutes les pages V1 seront
// validees en design.
