        ...
        columns: [
          {
            ...
            items: [
              { label: locale === 'fr' ? 'Supercars' : 'Supercars', href: '/services/cars/by-category/supercar' },
              { label: locale === 'fr' ? 'Performance' : 'Performance', href: '/services/cars/by-category/sport' },
              { label: 'SUV', href: '/services/cars/by-category/suv' },
              { label: locale === 'fr' ? 'Cabriolets' : 'Convertibles', href: '/services/cars/by-category/convertible' },
              { label: locale === 'fr' ? 'Berlines' : 'Sedans', href: '/services/cars/by-category/sedan' },
          ...
          },
          {
            ...
            titleFr: 'Par marque',
            items: [
              { label: 'Ferrari', href: '/services/cars/by-brand/ferrari' },
              { label: 'Lamborghini', href: '/services/cars/by-brand/lamborghini' },
              { label: 'Porsche', href: '/services/cars/by-brand/porsche' },
              { label: 'Bentley', href: '/services/cars/by-brand/bentley' },
              { label: 'Rolls Royce', href: '/services/cars/by-brand/rolls-royce' },
              { label: 'Mercedes', href: '/services/cars/by-brand/mercedes' },
            ],
          },
          {
            titleEn: 'For events',
        ...
        columns: [
          {
            ...
            titleFr: 'Par taille',
            items: [
              { label: locale === 'fr' ? '15 à 20 mètres' : '15 to 20 metres', href: '/services/yacht/by-size/15-20m' },
              { label: locale === 'fr' ? '20 à 30 mètres' : '20 to 30 metres', href: '/services/yacht/by-size/20-30m' },
              { label: locale === 'fr' ? '30 à 50 mètres' : '30 to 50 metres', href: '/services/yacht/by-size/30-50m' },
              { label: locale === 'fr' ? 'Plus de 50 mètres' : 'Above 50 metres', href: '/services/yacht/by-size/50m+' },
          ...
          },
          {
            ...
            titleFr: 'Par type',
            items: [
              { label: locale === 'fr' ? 'Yachts moteur' : 'Motor yachts', href: '/services/yacht/by-type/motor' },
              { label: locale === 'fr' ? 'Voiliers' : 'Sailing yachts', href: '/services/yacht/by-type/sail' },
              { label: 'Catamarans', href: '/services/yacht/by-type/catamaran' },
            ],
          },
          {
            ...
            items: [
              { label: 'Cannes', href: '/services/yacht/by-port/cannes' },
              { label: 'Monaco', href: '/services/yacht/by-port/monaco' },
              { label: 'Saint-Tropez', href: '/services/yacht/by-port/saint-tropez' },
            ],
          },
        ],
